          ...
          <>
            ...
            >
              ...
              <div className="flex-1 p-4">
                <div className="bg-[#E8EAF6] rounded-2xl p-4 mb-4">
                  <p className="text-sm text-[#4A5568]">
                    Hi {user.firstName}! I'm here to help with your learning journey. You can ask me about:
                  </p>
                  <ul className="mt-2 space-y-1 text-sm text-[#4A5568]">
                    <li>• Your progress and next steps</li>
                    <li>• Module recommendations</li>
                    <li>• Company policies and benefits</li>
                    <li>• Learning tips and strategies</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="p-4 border-t border-[#D6D9E0]">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-[#D6D9E0] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0A6ED1] focus:border-transparent"
                  />
                  <button className="bg-[#0A6ED1] hover:bg-[#0859ab] text-white px-4 py-2 rounded-xl">
                    Send
                  </button>
                </div>
              </div>
